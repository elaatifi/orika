...
public class CodeSourceBuilder {
	...
	public CodeSourceBuilder setCollection(Property dp, Property sp) {
		...
		append("destination.%s(mapperFacade.mapAs%s(source.%s, %s.class, mappingContext));", setter, destinationCollection,
				getter, destinationElementClass.getName());
		return this;
	}
	...
	public CodeSourceBuilder setWrapper(Property dp, Property sp) {
		...
		append("destination.%s(%s.valueOf((%s) source.%s));\n", setter, dp.getType().getName(), getPrimitiveType(dp.getType()),
				getter);
		return this;
	}
	...
	public CodeSourceBuilder setArray(Property dp, Property sp) {
		...
		append("%s[] %s = new %s[source.%s.%s];", paramType, dp.getName(), paramType, getter, getSizeCode).append(
				"mapperFacade.mapAsArray((Object[])%s, (%s)source.%s, %s.class, mappingContext);", dp.getName(), castSource,
				getter, paramType).append("destination.%s(%s);", setter, dp.getName());
